              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 border-2 border-zinc-100 dark:border-zinc-800 text-zinc-900 dark:text-white focus:border-accent dark:focus:border-accent outline-none transition-all resize-none h-32 font-medium"
